...
SECRET_KEY = 'django-insecure-ysmty4irf7c$br#2zn_g^$^+mfkx^l5%r-xw=9smza@dc6hth('
...
INSTALLED_APPS = [
    ...
    'hospital_webapp.apps.HospitalWebappConfig',
]
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'thirstolearn@gmail.com'
EMAIL_HOST_PASSWORD = 'ecop dzxc vxop tczc'
EMAIL_USE_TLS = True
